...
public class TrainStationLayer : VectorLayer<TrainStation>, ITrainStationLayer
{
    ...
    {
        get { return _anyPosition ??= Nearest(Position.CreateGeoPosition(0, 0)).Position; }
    }

    public TrainStation? Nearest(Position? position, Func<TrainStation, bool>? predicate = null)
    {
        return Nearest(position != null ? position.PositionArray : _anyPosition.PositionArray, predicate);
    }
