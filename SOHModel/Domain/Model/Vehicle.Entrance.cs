...
{
    /// <summary>
    ///     The collection of passenger entered this vehicle.
    /// </summary>
    public List<IPassengerCapable> Passengers { get; set; } = [];
    ...
    public virtual void NotifyPassengers(PassengerMessage passengerMessage)
    {
        ...
        foreach (var passenger in Passengers.ToArray().WhereNotNull())
        {
            passenger.Notify(passengerMessage);
        }
    }

    public void LeaveVehicle(TPassengerCapable passenger)
    {
