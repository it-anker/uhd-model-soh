...
public class WalkingFerryDrivingMultimodalRoute : MultimodalRoute
{
        ...
        IFerryStationLayer stationLayer, Position start, Position goal)
    {
        ...
        IEnumerable<Route> ferryRoutes;
        if (goalFerryStation != null && startFerryStation != null)
        {
            ferryRoutes = FindFerryRoutes(startFerryStation, goalFerryStation);
        }
        else
        {
            ferryRoutes = ArraySegment<Route>.Empty;
        }
