...
/// </summary>
[ApiController]
public class ProcessDescriptionApiController : ControllerBase
{
    /// <summary>
    ...
    [SwaggerResponse(200, type: typeof(Models.Ogc.Process), description: "A process description.")]
    ...
    public virtual IActionResult GetProcessDescription([FromRoute] [Required] string processID)
    {
        ...
        Models.Ogc.Process? example = exampleJson != null
            ? JsonConvert.DeserializeObject<Models.Ogc.Process>(exampleJson)
